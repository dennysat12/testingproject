...
router.get('/', function (req, res) {
    ...
    connection.query(`SELECT * FROM jam_akademik_a WHERE tipe_aka LIKE '%akademik_c2%'`, function (err, rows) {
        if (err) {
...
router.get('/test', function (req, res) {
    ...
    const baru = await connection.query ('SELECT * FROM jam_akademik_a WHERE tipe_aka = ? '  ,[mapeltipe.id],function (err, rows) {
