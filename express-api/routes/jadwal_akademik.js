...
router.post('/store', [
    ...
    if (!req.body.jamke || req.body.jamke.length==0 || !req.body.kelas || req.body.kelas.length==0 || !req.body.hari || req.body.hari.length==0 || !req.body.mapel || req.body.mapel.length==0 ) {
